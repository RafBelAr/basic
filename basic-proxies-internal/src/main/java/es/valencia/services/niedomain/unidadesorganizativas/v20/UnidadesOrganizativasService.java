 ...
 * 2016-08-11T11:49:47.342+02:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "UnidadesOrganizativasService", 
                  wsdlLocation = "http://prebus.valencia.es:7011/sbresource?WSDL/NotasInterioresElectronicas-pruebas/Servicios/Comunicaciones/Proveedores/UnidadesOrganizativasSOA_v2.0_concreto",
                  targetNamespace = "http://www.valencia.es/services/nieDomain/UnidadesOrganizativas/v20") 
public class UnidadesOrganizativasService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.valencia.es/services/nieDomain/UnidadesOrganizativas/v20", "UnidadesOrganizativasService");
    public final static QName UnidadesOrganizativasSOAP11 = new QName("http://www.valencia.es/services/nieDomain/UnidadesOrganizativas/v20", "UnidadesOrganizativasSOAP11");
    static {
        URL url = null;
        try {
            url = new URL("http://prebus.valencia.es:7011/sbresource?WSDL/NotasInterioresElectronicas-pruebas/Servicios/Comunicaciones/Proveedores/UnidadesOrganizativasSOA_v2.0_concreto");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UnidadesOrganizativasService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://prebus.valencia.es:7011/sbresource?WSDL/NotasInterioresElectronicas-pruebas/Servicios/Comunicaciones/Proveedores/UnidadesOrganizativasSOA_v2.0_concreto");
        }
        WSDL_LOCATION = url;
    }
