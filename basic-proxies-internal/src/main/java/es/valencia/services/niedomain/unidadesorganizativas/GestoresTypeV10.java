 ...
 *       &lt;sequence>
 *         &lt;element name="Gestor" type="{http://www.valencia.es/schema/nie/Common}CodUsuarioType_v1.0" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GestoresTypeV10 {
     ...
     * 
     */
    public List<String> getGestor() {
        if (gestor == null) {
            gestor = new ArrayList<String>();
        }
        return this.gestor;
    }
