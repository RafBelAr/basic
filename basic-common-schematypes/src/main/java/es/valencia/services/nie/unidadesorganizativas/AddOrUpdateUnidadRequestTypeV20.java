...
import es.valencia.schema.nie.unidadorganizativa.SustitutosTypeV20;


/**
 * <p>Clase Java para AddOrUpdateUnidadRequestType_v2.0 complex type.
 * 
 ...
 *         &lt;element name="Sustitutos" type="{http://www.valencia.es/schema/nie/UnidadOrganizativa}SustitutosType_v2.0" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends RequestMessageBaseTypeV10
{
    ...
    @XmlElementRef(name = "NombreCargoCas", namespace = "http://www.valencia.es/services/nie/UnidadesOrganizativas", type = JAXBElement.class, required = false)
    protected JAXBElement<String> nombreCargoCas;
    @XmlElementRef(name = "NombreCargoVal", namespace = "http://www.valencia.es/services/nie/UnidadesOrganizativas", type = JAXBElement.class, required = false)
