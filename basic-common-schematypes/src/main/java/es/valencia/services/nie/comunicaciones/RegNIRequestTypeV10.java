...
/**
 * <p>Clase Java para RegNIRequestType_v1.0 complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="RegNIRequestType_v1.0">
 *   &lt;complexContent>
...
@XmlType(name = "RegNIRequestType_v1.0", propOrder = {
    "numeroRegistro"
})
@XmlSeeAlso({
    UpdateNIRequestTypeV10 .class,
    GetNIRequestTypeV10 .class
})
public class RegNIRequestTypeV10
